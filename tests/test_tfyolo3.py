...
def test_model_DenseNet121(test_dataset, test_anchors, test_masks, test_classes):
    img_shape = test_dataset.target_shape
...
def test_model_DenseNet169(test_dataset, test_anchors, test_masks, test_classes):
    img_shape = test_dataset.target_shape
...
def test_model_DenseNet201(test_dataset, test_anchors, test_masks, test_classes):
    img_shape = test_dataset.target_shape
...
def test_model_MobileNetV2(test_dataset, test_anchors, test_masks, test_classes):
    img_shape = test_dataset.target_shape
